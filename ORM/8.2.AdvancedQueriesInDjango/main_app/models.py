...
from main_app.validators import RatingValidator
...
class VideoGame(models.Model):
    ...
    release_year = models.PositiveIntegerField(
        validators=[
            RatingValidator(1990, 2023, "The release year must be between 1990 and 2023")
        ]
    )
    ...
    rating = models.DecimalField(
        ...
        decimal_places=1,
        validators=[
            RatingValidator(0, 10, "The rating must be between 0.0 and 10.0")
        ]
    )
